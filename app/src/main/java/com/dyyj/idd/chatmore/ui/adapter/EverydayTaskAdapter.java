...
public class EverydayTaskAdapter extends BaseQuickAdapter<EverydayTaskResult.Data.EverydayTaskData, BaseViewHolder> {
    public EverydayTaskAdapter(@Nullable List<EverydayTaskResult.Data.EverydayTaskData> data) {
        super(R.layout.item_everyday_task, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, EverydayTaskResult.Data.EverydayTaskData item) {
