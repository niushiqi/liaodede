...
import com.dyyj.idd.chatmore.databinding.ActivityThreeReceiveTaskBinding
import com.dyyj.idd.chatmore.utils.RxTimerUtil
import com.dyyj.idd.chatmore.viewmodel.ReceiveTaskViewModel

class ReceiveThreeTaskActivity : BaseActivityV2<ActivityThreeReceiveTaskBinding, ReceiveTaskViewModel>() {
    companion object {
        ...
        fun start(context: Context, title: String, gold: Double?, stone: Double?, money: Double?, rewardId: String, autoClose: Boolean = false) {
            val intent = Intent(context, ReceiveThreeTaskActivity::class.java)
    ...
    override fun onLayoutId(): Int {
        return R.layout.activity_three_receive_task
    }
