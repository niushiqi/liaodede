...
public class BadgeUtils {
     ...
     * @paramcontext The context of the application package.

     * @returnlauncher activity name of this application. From the
    ...
    public static void setBadgeCount(Context context, int msgCount){
        ...
        ShortcutBadger.applyCount(context, msgCount); //for 1.1.4+
    ...
    private static void setBadgeOfEXUI(Context context, int count){
        ...
        try{
            ...
            context.getContentResolver().call(
                    ...
                    Uri.parse( "content://com.huawei.android.launcher.settings/badge/"), "change_badge", null, badgeBundle);
