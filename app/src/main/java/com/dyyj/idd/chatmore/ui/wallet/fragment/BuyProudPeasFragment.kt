...
import com.dyyj.idd.chatmore.databinding.FragmentBuyProudPeasBinding
...
import com.dyyj.idd.chatmore.viewmodel.BuyProudPeasViewModel
 ...
 * desc 买得豆页面
 */
class BuyProudPeasFragment : BaseFragment<FragmentBuyProudPeasBinding, BuyProudPeasViewModel>() {

    private val SDK_PAY_FLAG = 1

    var paidFor: List<RecycleShopResult.Data.Dedou>? = null
    companion object {
        var mInstance: BuyProudPeasFragment? = null
        var matchStatusTitle: String? = null
        /**
         * 单例
         */
        fun instance(): BuyProudPeasFragment {
            if (mInstance == null) {
                return BuyProudPeasFragment()
            }
            return mInstance!!
        }
    }
    ...
    override fun onLayoutId(): Int {
        return R.layout.fragment_buy_proud_peas
    }

    override fun onViewModel(): BuyProudPeasViewModel {
        return BuyProudPeasViewModel()
    }
    ...
    @Subscribe
    fun onDataSuc(obj: BuyProudPeasViewModel.PeaListVM) {
        initRecycleView(obj)
    }

    fun initRecycleView(obj: BuyProudPeasViewModel.PeaListVM) {
        //设置线
    ...
    var orderGoodsId = ""
    @Subscribe
    fun onAlipayOrderVM(obj: BuyProudPeasViewModel.AlipayOrderVM) {
