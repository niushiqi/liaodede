...
public class AudioMngHelper {
    ...
    @IntDef({TYPE_MUSIC, TYPE_ALARM, TYPE_RING,TYPE_VOICE_CALL,TYPE_SYSTEM})
    ...
    public AudioMngHelper addVoiceSystem() {
        audioManager.adjustStreamVolume(NOW_AUDIO_TYPE, AudioManager.ADJUST_RAISE,AudioManager.FX_FOCUS_NAVIGATION_UP);
        return this;
    }

    public AudioMngHelper subVoiceSystem() {
        audioManager.adjustStreamVolume(NOW_AUDIO_TYPE, AudioManager.ADJUST_LOWER,AudioManager.FX_FOCUS_NAVIGATION_UP);
        return this;
    }
