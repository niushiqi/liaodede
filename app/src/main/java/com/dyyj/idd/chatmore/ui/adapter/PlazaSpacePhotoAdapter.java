...
public class PlazaSpacePhotoAdapter extends RecyclerView.Adapter<PlazaSpacePhotoAdapter.ViewHolder> {

    private Context context;
    private List<String> mData;
    private String id;

    public PlazaSpacePhotoAdapter(Context context, List<String> mData, String id) {
