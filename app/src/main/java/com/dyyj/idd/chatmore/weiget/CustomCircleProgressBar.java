...
public class CustomCircleProgressBar extends View {
  ...
  enum DirectionEnum {
    LEFT(0, 180.0f), TOP(1, 270.0f), RIGHT(2, 0.0f), BOTTOM(3, 90.0f);
  ...
  public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray a = context.getTheme()
        .obtainStyledAttributes(attrs, R.styleable.CustomCircleProgressBar, defStyleAttr, 0);
    outsideColor = a.getColor(R.styleable.CustomCircleProgressBar_outside_color,
        ContextCompat.getColor(getContext(), R.color.primary));
    outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius,
        DeviceUtils.dp2px(getContext().getResources(), 60.0f));
    insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color,
        ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
    progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color,
        ContextCompat.getColor(getContext(), R.color.primary));
    progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size,
        DeviceUtils.dp2px(getContext().getResources(), 14.0f));
    progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width,
        DeviceUtils.dp2px(getContext().getResources(), 10.0f));
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    canvas.drawArc(oval, DirectionEnum.getDegree(direction), 360 * (progress / maxProgress), false,
        paint);  //根据进度画圆弧
  ...
  private void startAnim(float startProgress) {
    animator = ValueAnimator.ofFloat(0, startProgress);
    ...
    animator.addListener(new Animator.AnimatorListener() {
      @Override public void onAnimationStart(Animator animator) {
        Timber.tag("animation").i(animator.toString());
      }
