...
public class SlidingTabLayout extends HorizontalScrollView implements LazyViewPager.OnPageChangeListener {
    ...
    /** 关联ViewPager */
    public void setViewPager(LazyViewPager vp) {
    ...
    public void setViewPager(LazyViewPager vp, String[] titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
    ...
    public void setViewPager(LazyViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        if (vp == null) {
