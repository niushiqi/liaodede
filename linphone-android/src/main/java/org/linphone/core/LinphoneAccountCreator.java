...
public interface LinphoneAccountCreator {
	interface LinphoneAccountCreatorListener {
		void onAccountCreatorIsAccountUsed(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorAccountCreated(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorAccountActivated(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorAccountLinkedWithPhoneNumber(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorPhoneNumberLinkActivated(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorIsAccountActivated(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorPhoneAccountRecovered(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorIsAccountLinked(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorIsPhoneNumberUsed(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
		void onAccountCreatorPasswordUpdated(LinphoneAccountCreator accountCreator,
        RequestStatus RequestStatus);
	}
