...
public interface LinphoneCore {
	...
	**/
	 ...
	 */
	public LinphoneEvent subscribe(LinphoneAddress resource, String event, int expires,
	 ...
	 */
	public LinphoneEvent publish(LinphoneAddress resource, String event, int expires,
      LinphoneContent content);
	...
	public LinphoneProxyConfig createProxyConfig(String identity, String proxy, String route,
	...
	**/
	...
	/**
	  ...
	  */
	public LinphoneCallLog createCallLog(LinphoneAddress from, LinphoneAddress to, CallDirection dir,
      int duration, long start, long connected, LinphoneCallLog.CallStatus status,
