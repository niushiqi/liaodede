...
public interface LinphoneChatMessage {
	...
	interface LinphoneChatMessageListener {
		 ...
		 */
		void onLinphoneChatMessageFileTransferReceived(LinphoneChatMessage msg, LinphoneContent content,
		 ...
		 */
		void onLinphoneChatMessageFileTransferSent(LinphoneChatMessage msg, LinphoneContent content,
        int offset, int size, LinphoneBuffer bufferToFill);
		 ...
		 */
		void onLinphoneChatMessageFileTransferProgressChanged(LinphoneChatMessage msg,
