...
public interface LinphoneFriendList {
	...
	**/
	 ...
	 */
	void setListener(LinphoneFriendListListener listener);

	interface LinphoneFriendListListener {
		void onLinphoneFriendCreated(LinphoneFriendList list, LinphoneFriend lf);

		void onLinphoneFriendUpdated(LinphoneFriendList list, LinphoneFriend newFriend,
        LinphoneFriend oldFriend);

		void onLinphoneFriendDeleted(LinphoneFriendList list, LinphoneFriend lf);

		void onLinphoneFriendSyncStatusChanged(LinphoneFriendList list, State status, String message);
	}
