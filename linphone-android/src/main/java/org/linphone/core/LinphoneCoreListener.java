...
public interface LinphoneCoreListener {
	 ...
	 **/
	void authenticationRequested(LinphoneCore lc, LinphoneAuthInfo authInfo,
      LinphoneCore.AuthMethod method);
	 ...
	 */
	void fileTransferProgressIndication(LinphoneCore lc, LinphoneChatMessage message,
      LinphoneContent content, int progress);
	 ...
	 * @param size
	 */
	void fileTransferRecv(LinphoneCore lc, LinphoneChatMessage message, LinphoneContent content,
	 ...
	 */
	int fileTransferSend(LinphoneCore lc, LinphoneChatMessage message, LinphoneContent content,
	 ...
	 * */
	void registrationState(LinphoneCore lc, LinphoneProxyConfig cfg,
	 ...
	 */
	void configuringStatus(LinphoneCore lc, LinphoneCore.RemoteProvisioningState state,
      String message);
	 ...
	 * @param message incoming linphone chat message message
     */
	void messageReceivedUnableToDecrypted(LinphoneCore lc, LinphoneChatRoom cr,
	 ...
	 */
	void callEncryptionChanged(LinphoneCore lc, LinphoneCall call, boolean encrypted,
	 ...
	 * @param data
	 */
	void ecCalibrationStatus(LinphoneCore lc, LinphoneCore.EcCalibratorStatus status, int delay_ms,
      Object data);
